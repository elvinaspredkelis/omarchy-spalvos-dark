# Spalvos Dark — Omarchy theme

Mirror of [`spalvos`](https://github.com/elvinaspredkelis/spalvos)'s
`omarchy/spalvos-dark` — a standalone repo so Omarchy can install it
...
```sh
omarchy theme install https://github.com/elvinaspredkelis/omarchy-spalvos-dark
```
